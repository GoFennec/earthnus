...
<div class="container"><br>
	...
	<form action="/adGoods/updateOk" method="POST" enctype="multipart/form-data">
		<table class="insertFormTable">
			...
			<tr><td class="td_left"><label for="goods_info">상&nbsp;품&nbsp;&nbsp;정&nbsp;보&nbsp;&nbsp;&nbsp;</label></td>
				<td class="td_right"><input type="text" name="goods_info" id="goods_info" value="${goods.goods_info}" required></td></tr>
			<tr><td class="td_left"><label for="goods_desc">상&nbsp;품&nbsp;&nbsp;설&nbsp;명&nbsp;&nbsp;&nbsp;</label></td>
				<td class="td_right"><textarea cols="26" rows="6" style="resize: none;" name="goods_desc" id="goods_desc" required>${goods.goods_desc}</textarea></td></tr>
			<tr><td class="td_left"><label for="goods_uploadFile">상&nbsp;품&nbsp;&nbsp;사&nbsp;진&nbsp;&nbsp;&nbsp;</label></td>
				<td class="td_right"><input type="file" name="goods_uploadFile" id="goods_uploadFile" value="${goods.goods_num}">
