      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse show" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="/adExGoods/dList">배송 처리 목록</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">지구마켓 배송 처리 목록</h1>
          </div>
					...
					<tbody>
                    	<c:forEach items="${exGoodsList}" var="exGoods">
							<tr class="exGoodsInfo" id="${exGoods.exg_num}">
								...
								<td>${exGoods.exg_cc}</td>
								<td>${exGoods.exg_waybill}</td>
								<td><fmt:formatDate pattern="yyyy년 MM월 dd일 HH시 mm분" value="${exGoods.exg_pdate}"/></td>
								<td><fmt:formatDate pattern="yyyy년 MM월 dd일 HH시 mm분" value="${exGoods.exg_ddate}"/></td>
							</tr>
						</c:forEach>
                    </tbody>
                  </table>
