...
<div class="container" style="max-width:450px">
  <main>
    ...
    <div class="row g-5">
      <div class="">
        <form class="needs-validation" action="/member/join_naver" method="post" novalidate>
          <div class="row g-3">
          
                <div class="col-12">
              <label for="username" class="form-label">아이디</label>
              <input type="text" name="mem_id"class="form-control" value="${mem_id }"  readonly>
                </div>
          
            <div class="col-12">
              <label for="username" class="form-label">이름</label>
              <input type="text" id="mem_name" name="mem_name"class="form-control" value="${mem_name}" readonly>
            </div>
                        <div class="col-12">
...
 					}
         ...
         <div class="row gy-3">
            ...
            <div class="col-md-12">
              ...
              <input type="text" name="mem_tel" class="form-control" id="mem_tel"  maxlength='11' value="${mem_tel}">
              <div class="invalid-feedback">
                	필수 입력사항입니다.
              </div>
